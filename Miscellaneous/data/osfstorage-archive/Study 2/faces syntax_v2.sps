...
** Removing the outliers (with regard to duration of the study)

DESCRIPTIVES VARIABLES=Duration__in_seconds_
  /SAVE
  /STATISTICS=MEAN STDDEV MIN MAX.

USE ALL.
COMPUTE filter_$=(ZDuration__in_seconds_ > -3 & ZDuration__in_seconds_ < 3).
VARIABLE LABELS filter_$ 'ZDuration__in_seconds_ > -3 & ZDuration__in_seconds_ < 3 (FILTER)'.
