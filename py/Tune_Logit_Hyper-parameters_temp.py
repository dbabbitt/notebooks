...
tuned_parameters = [
                    ...
                    # 'liblinear' and 'saga' handle L1 penalty {'penalty': ['l1'], 'solver': ['liblinear', 'saga'], 'tol': [1e-5, 1e-4, 1e-3], 'C': [0.1, 1.0, 10.0], 'class_weight': [None, 'balanced'], 'max_iter': [250, 500, 1000]},
                    
                    # 'liblinear' does not support setting penalty='none' {'penalty': ['l2'], 'solver': ['liblinear'], 'dual': [True, False], 'tol': [1e-5, 1e-4, 1e-3], 'C': [0.1, 1.0, 10.0], 'fit_intercept': [False], 'class_weight': [None, 'balanced'], 'max_iter': [250, 500, 1000]},
                    
                    # 'liblinear' does not support setting penalty='none' {'penalty': ['l2'], 'solver': ['liblinear'], 'dual': [True, False], 'tol': [1e-5, 1e-4, 1e-3], 'C': [0.1, 1.0, 10.0], 'fit_intercept': [True], 'intercept_scaling': [1, 10, 100], 'class_weight': [None, 'balanced'], 'max_iter': [250, 500, 1000]},
                    
                    # 'newton-cg', 'lbfgs', 'sag' and 'saga' handle L2 or no penalty {'penalty': ['l2'], 'solver': ['newton-cg', 'lbfgs', 'sag', 'saga'], 'tol': [1e-5, 1e-4, 1e-3], 'C': [0.1, 1.0, 10.0], 'class_weight': [None, 'balanced'], 'max_iter': [250, 500, 1000], 'warm_start': [True]},
                    
                    # 'newton-cg', 'lbfgs', 'sag' and 'saga' handle L2 or no penalty {'penalty': ['none'], 'solver': ['newton-cg', 'lbfgs', 'sag', 'saga'], 'tol': [1e-5, 1e-4, 1e-3], 'class_weight': [None, 'balanced'], 'max_iter': [250, 500, 1000], 'warm_start': [True]},
                    
                    # 'saga' also supports 'elasticnet' penalty {'penalty': ['elasticnet'], 'solver': ['saga'], 'tol': [1e-5, 1e-4, 1e-3], 'C': [0.1, 1.0, 10.0], 'class_weight': [None, 'balanced'], 'max_iter': [250, 500, 1000], 'warm_start': [True], 'l1_ratio': [0, 0.5, 1]}
